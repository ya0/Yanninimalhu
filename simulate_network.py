...
if __name__ == "__main__":
    ...
    average_fraction_array=np.zeros(number_cases) #Array with the averages of fraction of cooperators per simulation
    for z in range(0,number_cases):
        ...
        for j in range(0,number_single):
            ...
            # perform simulation
            cooperator_fraction_ts=simulate(world, stats, time_max, iteration_max, show_animation)
            average_fraction_single+=cooperator_fraction_ts[-1]
            print("Sum of fractions for each simulation and each loop:", average_fraction_single)
        average_fraction_array[z]=average_fraction_single/number_single
        average_fraction_single=0
        print("Average fraction of cooperators for each simulation=", average_fraction_array[z])
